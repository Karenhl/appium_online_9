...
class LoginPage(BasePage):
    ...
    def login_by_msg(self, phone, code):
        return self
    ...
    def login_by_password(self, account, password):
        ...
        self.load_steps("../data/LoginPage.yaml", "login_by_password", var1=account, var2=password)
        return self

    def login_success_by_password(self, account, password):
